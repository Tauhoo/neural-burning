...
# Tue Mar 16 03:42:04 ICT 2021
# DO NOT MODIFY


# 
# dense_to_activate_register "dense_to_activate_register" v1.0
# Wachirawit Wacharak 2021.03.16.03:42:04
# Buffer data between dense layer and activate layer
# 
...
# 
# module dense_to_activate_register
# 
set_module_property DESCRIPTION "Buffer data between dense layer and activate layer"
set_module_property NAME dense_to_activate_register
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP neural_burning/registers
set_module_property AUTHOR "Wachirawit Wacharak"
set_module_property DISPLAY_NAME dense_to_activate_register
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL dense_activate_reg
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file dense_activate_reg.sv SYSTEM_VERILOG PATH ../register_delay/registers/dense_activate_reg.sv TOP_LEVEL_FILE
...
add_interface_port in_forward_interface act_type act_type Input act_type_size


# 
# connection point out_activate_interface
# 
add_interface out_activate_interface conduit end
set_interface_property out_activate_interface associatedClock ""
set_interface_property out_activate_interface associatedReset ""
set_interface_property out_activate_interface ENABLED true
set_interface_property out_activate_interface EXPORT_OF ""
set_interface_property out_activate_interface PORT_NAME_MAP ""
set_interface_property out_activate_interface CMSIS_SVD_VARIABLES ""
set_interface_property out_activate_interface SVD_ADDRESS_GROUP ""

add_interface_port out_activate_interface y_out data_stream Output data_size*size
add_interface_port out_activate_interface act_type_out act_type Output act_type_size
...
add_interface_port out_forward_interface dense_type_out dense_type Output dense_type_size
add_interface_port out_forward_interface cost_type_out cost_type Output cost_type_size
add_interface_port out_forward_interface w_out w Output data_size*size
add_interface_port out_forward_interface x_out x Output data_size*size
add_interface_port out_forward_interface predict_value_out label Output data_size*size
add_interface_port out_forward_interface act_type_forward_out act_type Output act_type_size
add_interface_port out_forward_interface y_out_forward y Output data_size*size


# 
# connection point in_y_interface
# 
add_interface in_y_interface conduit end
set_interface_property in_y_interface associatedClock ""
set_interface_property in_y_interface associatedReset ""
set_interface_property in_y_interface ENABLED true
set_interface_property in_y_interface EXPORT_OF ""
set_interface_property in_y_interface PORT_NAME_MAP ""
set_interface_property in_y_interface CMSIS_SVD_VARIABLES ""
set_interface_property in_y_interface SVD_ADDRESS_GROUP ""

add_interface_port in_y_interface y y_stream Input data_size*size
...
set_interface_property learning_rate_out_interface associatedClock ""
