...
# Sat Mar 20 06:03:05 ICT 2021
# DO NOT MODIFY


# 
# controller "controller" v1.0
# Wachirawit Wacharak 2021.03.20.06:03:05
...
add_parameter param_a_size INTEGER 4
set_parameter_property param_a_size DEFAULT_VALUE 4
set_parameter_property param_a_size DISPLAY_NAME param_a_size
set_parameter_property param_a_size TYPE INTEGER
set_parameter_property param_a_size UNITS None
set_parameter_property param_a_size ALLOWED_RANGES -2147483648:2147483647
set_parameter_property param_a_size HDL_PARAMETER true
add_parameter param_b_size INTEGER 4
set_parameter_property param_b_size DEFAULT_VALUE 4
set_parameter_property param_b_size DISPLAY_NAME param_b_size
set_parameter_property param_b_size TYPE INTEGER
set_parameter_property param_b_size UNITS None
set_parameter_property param_b_size ALLOWED_RANGES -2147483648:2147483647
set_parameter_property param_b_size HDL_PARAMETER true
...
add_interface_port backprop_controll_interface backprop_controll backprop_controll Output backprop_controll_size


# 
# connection point parse_interface
# 
add_interface parse_interface conduit end
set_interface_property parse_interface associatedClock ""
set_interface_property parse_interface associatedReset ""
set_interface_property parse_interface ENABLED true
set_interface_property parse_interface EXPORT_OF ""
set_interface_property parse_interface PORT_NAME_MAP ""
set_interface_property parse_interface CMSIS_SVD_VARIABLES ""
set_interface_property parse_interface SVD_ADDRESS_GROUP ""

add_interface_port parse_interface set_act_type set_act_type Output 1
add_interface_port parse_interface set_cost_type set_cost_type Output 1
add_interface_port parse_interface set_dense_type set_dense_type Output 1
add_interface_port parse_interface set_learning_rate_value set_learning_rate Output 1
...
add_interface_port parameter_interface param_a param_a Input param_a_size
add_interface_port parameter_interface param_b param_b Input param_b_size
add_interface_port parameter_interface param_c param_c Input param_a_size+param_b_size
add_interface_port parameter_interface op op Input op_size


# 
# connection point code_reset_interface
# 
add_interface code_reset_interface conduit end
set_interface_property code_reset_interface associatedClock ""
set_interface_property code_reset_interface associatedReset ""
set_interface_property code_reset_interface ENABLED true
set_interface_property code_reset_interface EXPORT_OF ""
set_interface_property code_reset_interface PORT_NAME_MAP ""
set_interface_property code_reset_interface CMSIS_SVD_VARIABLES ""
set_interface_property code_reset_interface SVD_ADDRESS_GROUP ""

add_interface_port code_reset_interface code_reset_address code_reset_address Output 32
add_interface_port code_reset_interface update_code_reset_address update_code_reset_address Output 1
add_interface_port code_reset_interface code_reset_count code_reset_count Output 32
add_interface_port code_reset_interface update_code_reset_count update_code_reset_count Output 1
